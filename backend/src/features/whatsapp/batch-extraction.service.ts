...
async function contextFor(conversation: WhatsAppConversation): Promise<Context> {
  ...
  return { currentStep: conversation.currentStep, draft: conversation.draft, sites: [...siteMap.values()] };
}
