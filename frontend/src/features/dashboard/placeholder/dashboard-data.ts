...
export const dashboardSnapshot = {
  ...
  recentBatches: [
    { id: "B-104", product: "Chilled red snapper fillet", productionSite: "Muara Baru Plant", productionLines: ["Line 2A", "QC Bench 1"], processTags: ["Cutting", "Quality control"], shift: "Morning", source: "WhatsApp", inputKg: 250, filletKg: 112, trimmingKg: 19, rejectKg: 8, byProductKg: 111, yieldPct: 44.8, baselinePct: 48.4, status: "investigation_suggested", receivedAt: "Today, 07:18" },
    { id: "B-103", product: "Frozen red snapper fillet", productionSite: "Muara Baru Plant", productionLines: ["Line 1F"], processTags: ["Cutting", "Freezing"], shift: "Night", source: "Web", inputKg: 310, filletKg: 150, trimmingKg: 22, rejectKg: 5, byProductKg: 133, yieldPct: 48.4, baselinePct: 48.2, status: "analyzed", receivedAt: "18 Aug, 21:06" },
    { id: "B-102", product: "Chilled red snapper fillet", productionSite: "Muara Baru Plant", productionLines: ["Line 2A", "QC Bench 1"], processTags: ["Cutting", "Quality control"], shift: "Afternoon", source: "WhatsApp", inputKg: 220, filletKg: 101, trimmingKg: 17, rejectKg: 7, byProductKg: 95, yieldPct: 45.9, baselinePct: 48.5, status: "analyzed", receivedAt: "15 Aug, 14:32" },
    { id: "B-101", product: "Chilled red snapper fillet", productionSite: "Ancol Support Site", productionLines: ["Line 3C"], processTags: ["Cutting", "Packaging"], shift: "Morning", source: "Web", inputKg: 280, filletKg: 136, trimmingKg: 20, rejectKg: 4, byProductKg: 120, yieldPct: 48.6, baselinePct: 48.3, status: "confirmed", receivedAt: "14 Aug, 08:11" }
  ] satisfies BatchRecord[],
  findings: [
    ...
    { title: "Quality reject is elevated on Line 2A activity", evidence: "Three low-yield batches this month share Line 2A and an arrival delay above 90 minutes.", confidence: "Medium", action: "Record receiving temperature on the next delayed Line 2A batch." },
  ...
  productionSiteSignals: [
    { productionSite: "Muara Baru Plant", batches: 14, medianYield: 46.1, rejectRate: 4.8, delayRate: 37.5, note: "Repeated association with soft-flesh reject on delayed Line 2A activity." },
    { productionSite: "Ancol Support Site", batches: 7, medianYield: 48.7, rejectRate: 1.9, delayRate: 16.7, note: "Stable yield across cutting and packaging lines." },
    { productionSite: "Kelapa Gading Site", batches: 5, medianYield: 48.2, rejectRate: 2.3, delayRate: 14.2, note: "Normal variance; no active recommendation." }
  ] satisfies ProductionSiteSignal[],
  investigations: [
    { id: "INV-18", title: "Check Line 2A receiving temperature", owner: "Rafi Pradana", status: "Suggested", due: "Next delayed batch" },
